...
<div class="painel-login">
	...
	<form action="" id="form-login" method="post">
		...
		<p>
			<input type="text" id="txtId" name="txtId" placeholder="ID" required="required">
			<input type="password" id="txtSenha" name="txtSenha" placeholder="Sua Senha" required="required">
